...
var Appointment_Repository_1 = __importDefault(require("../repositories/Appointment.Repository"));
...
appointmentsRouter.get('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                appointmentsRepository = typeorm_1.getCustomRepository(Appointment_Repository_1.default);
